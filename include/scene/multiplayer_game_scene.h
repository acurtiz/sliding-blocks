#ifndef SLIDINGBLOCKS_INCLUDE_SCENE_MULTIPLAYER_GAME_SCENE_H_
#define SLIDINGBLOCKS_INCLUDE_SCENE_MULTIPLAYER_GAME_SCENE_H_
...
#endif //SLIDINGBLOCKS_INCLUDE_SCENE_MULTIPLAYER_GAME_SCENE_H_
